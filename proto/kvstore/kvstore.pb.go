...
const file_proto_kvstore_kvstore_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/kvstore/kvstore.proto\x12\akvstore\"\x1e\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
	...
	"\x06Delete\x12\x16.kvstore.DeleteRequest\x1a\x17.kvstore.DeleteResponseBDZBgithub.com/Cellu83/sdcc-Progetto-b5-kvstor/proto/kvstore;kvstorepbb\x06proto3"
...
var file_proto_kvstore_kvstore_proto_depIdxs = []int32{
	0, // 0: kvstore.KVStoreService.Get:input_type -> kvstore.GetRequest
	2, // 1: kvstore.KVStoreService.Put:input_type -> kvstore.PutRequest
	4, // 2: kvstore.KVStoreService.Delete:input_type -> kvstore.DeleteRequest
	1, // 3: kvstore.KVStoreService.Get:output_type -> kvstore.GetResponse
	3, // 4: kvstore.KVStoreService.Put:output_type -> kvstore.PutResponse
